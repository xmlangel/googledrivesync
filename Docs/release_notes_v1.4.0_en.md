...
Google Drive Sync v1.4.0 has been released. This update introduces advanced synchronization features that significantly improve sync performance in large-scale file environments and enhance data integrity.
